...
> Fast. Reliable. Catches the catches-all.
...
python3 smtp\\\_enum.py --help
```
---
Usage
```
python3 smtp\\\_enum.py -t <TARGET> -d <DOMAIN> \\\[options]
```
Options
...
`-o`, `--output`	Output file for valid users	`valid\\\_users.txt`
